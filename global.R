...
PickGK <- read.csv("PickGK.csv", row.names = "X")
PickDF <- read.csv("PickDF.csv", row.names = "X")
PickMid <- read.csv("PickMid.csv", row.names = "X")
PickFor <- read.csv("PickFor.csv", row.names = "X")
